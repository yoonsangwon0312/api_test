...
export namespace Prisma {
  ...
  export type rs_memberSelect = {
    ...
    rs_board_admin?: boolean | FindManyrs_board_adminArgs
  ...
  export type rs_memberGetPayload<
    ...
    ? rs_member  & {
    [P in TrueKeys<S['include']>]: 
          P extends 'rs_board_admin'
        ? Array < rs_board_adminGetPayload<S['include'][P]>>  :
        ...
        ? Array < rs_mgr_memGetPayload<S['include'][P]>>  :
  ...
  export class Prisma__rs_memberClient<T> implements Promise<T> {
    ...
    rs_board_admin<T extends FindManyrs_board_adminArgs = {}>(args?: Subset<T, FindManyrs_board_adminArgs>): CheckSelect<T, Promise<Array<rs_board_admin>>, Promise<Array<rs_board_adminGetPayload<T>>>>;
  ...
  export type rs_board_categorySelect = {
    cat_idx?: boolean
    cat_title?: boolean
    rs_board_post?: boolean | FindManyrs_board_postArgs
  }

  export type rs_board_categoryInclude = {
    rs_board_post?: boolean | FindManyrs_board_postArgs
  }
  ...
  export type rs_board_categoryGetPayload<
    ...
    [P in TrueKeys<S['include']>]: 
        ...
        ? Array < rs_board_postGetPayload<S['include'][P]>>  : never
  } 
    : 'select' extends U
    ? {
  ...
  : 
          P extends 'rs_board_post'
        ? Array < rs_board_postGetPayload<S['select'][P]>>  : never
  } 
    : rs_board_category
  : rs_board_category
  ...
  export class Prisma__rs_board_categoryClient<T> implements Promise<T> {
    ...
    rs_board_post<T extends FindManyrs_board_postArgs = {}>(args?: Subset<T, FindManyrs_board_postArgs>): CheckSelect<T, Promise<Array<rs_board_post>>, Promise<Array<rs_board_postGetPayload<T>>>>;
  ...
  export type FindUniquers_board_categoryArgs = {
    ...
    **/
     ...
     * Choose, which related nodes to fetch as well.
    **/
    include?: rs_board_categoryInclude | null
    /**
  ...
  export type rs_board_postSelect = {
    ...
    rs_board_category?: boolean | rs_board_categoryArgs
    rs_board_likebad_map?: boolean | FindManyrs_board_likebad_mapArgs
  ...
  export type rs_board_postGetPayload<
    ...
    ? rs_board_post  & {
    [P in TrueKeys<S['include']>]: 
          P extends 'rs_board_category'
        ? rs_board_categoryGetPayload<S['include'][P]> :
        P extends 'rs_board_likebad_map'
        ? Array < rs_board_likebad_mapGetPayload<S['include'][P]>>  :
        P extends 'rs_note'
        ? Array < rs_noteGetPayload<S['include'][P]>>  : never
  ...
  : 
          P extends 'rs_board_category'
        ? rs_board_categoryGetPayload<S['select'][P]> :
        P extends 'rs_board_likebad_map'
        ? Array < rs_board_likebad_mapGetPayload<S['select'][P]>>  :
        P extends 'rs_note'
        ? Array < rs_noteGetPayload<S['select'][P]>>  : never
  ...
  export class Prisma__rs_board_postClient<T> implements Promise<T> {
    ...
    rs_board_category<T extends rs_board_categoryArgs = {}>(args?: Subset<T, rs_board_categoryArgs>): CheckSelect<T, Prisma__rs_board_categoryClient<rs_board_category | null>, Prisma__rs_board_categoryClient<rs_board_categoryGetPayload<T> | null>>;
  ...
  export type rs_noteGetPayload<
    ...
    [P in TrueKeys<S['include']>]: 
        ...
        ? rs_memberGetPayload<S['include'][P]> :
        P extends 'rs_board_post'
        ? rs_board_postGetPayload<S['include'][P]> :
  ...
  : 
        ...
        ? rs_memberGetPayload<S['select'][P]> :
        P extends 'rs_board_post'
        ? rs_board_postGetPayload<S['select'][P]> :
        P extends 'rs_member_rs_memberTors_note_not_send_id'
        ? rs_memberGetPayload<S['select'][P]> : never
  } 
    : rs_note
  ...
  export type rs_board_adminInclude = {
    rs_member?: boolean | rs_memberArgs
  }
  ...
  export type FindUniquers_board_adminArgs = {
    ...
    **/
     ...
     * Choose, which related nodes to fetch as well.
    **/
    include?: rs_board_adminInclude | null
    /**
  ...
  export type rs_memberWhereInput = {
    ...
    rs_board_admin?: Rs_board_adminListRelationFilter
  ...
  export type rs_board_categoryWhereInput = {
    ...
    rs_board_post?: Rs_board_postListRelationFilter
  }
  ...
  export type rs_board_postWhereInput = {
    ...
    rs_board_category?: XOR<rs_board_categoryWhereInput, Rs_board_categoryRelationFilter>
    rs_board_likebad_map?: Rs_board_likebad_mapListRelationFilter
  ...
  export type rs_noteWhereInput = {
    ...
    not_recv_id?: IntFilter | number
    not_send_id?: IntFilter | number
    ...
    rs_member_rs_memberTors_note_not_recv_id?: XOR<rs_memberWhereInput, Rs_memberRelationFilter>
    rs_board_post?: XOR<rs_board_postWhereInput, Rs_board_postRelationFilter>
    rs_member_rs_memberTors_note_not_send_id?: XOR<rs_memberWhereInput, Rs_memberRelationFilter>
  }
  ...
  export type rs_noteWhereUniqueInput = {
    not_idx?: number
    not_idx_not_recv_id_not_send_id_not_relate_post_idx?: Not_idxNot_recv_idNot_send_idNot_relate_post_idxCompoundUniqueInput
  }
  ...
  export type rs_memberCreateInput = {
    ...
    mem_inactive_check?: string | null
    mem_is_admin?: number
    rs_board_admin?: rs_board_adminCreateManyWithoutRs_memberInput
    rs_board_likebad_map?: rs_board_likebad_mapCreateManyWithoutRs_memberInput
    rs_mem_auth?: rs_mem_authCreateManyWithoutRs_memberInput
    rs_mgr_mem?: rs_mgr_memCreateManyWithoutRs_memberInput
  ...
  export type rs_memberUpdateInput = {
    ...
    rs_board_admin?: rs_board_adminUpdateManyWithoutRs_memberInput
    rs_board_likebad_map?: rs_board_likebad_mapUpdateManyWithoutRs_memberInput
    rs_mem_auth?: rs_mem_authUpdateManyWithoutRs_memberInput
    rs_mgr_mem?: rs_mgr_memUpdateManyWithoutRs_memberInput
  ...
  export type rs_board_categoryCreateInput = {
    cat_idx: number
    cat_title: string
    rs_board_post?: rs_board_postCreateManyWithoutRs_board_categoryInput
  }
  ...
  export type rs_board_categoryUpdateInput = {
    ...
    rs_board_post?: rs_board_postUpdateManyWithoutRs_board_categoryInput
  }
  ...
  export type rs_board_postCreateInput = {
    ...
    pst_mem_id: string
    pst_mem_nick: string
    rs_board_category: rs_board_categoryCreateOneWithoutRs_board_postInput
  ...
  export type rs_board_postUpdateInput = {
    ...
    rs_board_category?: rs_board_categoryUpdateOneRequiredWithoutRs_board_postInput
  ...
  export type rs_board_likebad_mapCreateInput = {
    ...
    rs_member: rs_memberCreateOneWithoutRs_board_likebad_mapInput
  }
  ...
  export type rs_board_likebad_mapUpdateInput = {
    ...
    rs_member?: rs_memberUpdateOneRequiredWithoutRs_board_likebad_mapInput
  }
  ...
  export type rs_noteUpdateInput = {
    ...
    rs_member_rs_memberTors_note_not_recv_id?: rs_memberUpdateOneRequiredWithoutRs_note_rs_memberTors_note_not_recv_idInput
    rs_board_post?: rs_board_postUpdateOneRequiredWithoutRs_noteInput
    rs_member_rs_memberTors_note_not_send_id?: rs_memberUpdateOneRequiredWithoutRs_note_rs_memberTors_note_not_send_idInput
  }
  ...
  export type rs_board_adminCreateInput = {
    adm_mem_id: string
    rs_member: rs_memberCreateOneWithoutRs_board_adminInput
  }

  export type rs_board_adminUpdateInput = {
    adm_mem_id?: StringFieldUpdateOperationsInput | string
    rs_member?: rs_memberUpdateOneRequiredWithoutRs_board_adminInput
  }
  ...
  export type Rs_board_adminListRelationFilter = {
    every?: rs_board_adminWhereInput
    some?: rs_board_adminWhereInput
    none?: rs_board_adminWhereInput
  }
  ...
  export type Rs_board_postListRelationFilter = {
    every?: rs_board_postWhereInput
    some?: rs_board_postWhereInput
    none?: rs_board_postWhereInput
  }
  ...
  export type Rs_board_categoryRelationFilter = {
    is?: rs_board_categoryWhereInput
    isNot?: rs_board_categoryWhereInput
  }
  ...
  export type Rs_board_postRelationFilter = {
    is?: rs_board_postWhereInput
    isNot?: rs_board_postWhereInput
  }

  export type Not_idxNot_recv_idNot_send_idNot_relate_post_idxCompoundUniqueInput = {
    not_idx: number
    not_recv_id: number
    not_send_id: number
    not_relate_post_idx: number
  ...
  export type rs_board_adminCreateManyWithoutRs_memberInput = {
    create?: Enumerable<rs_board_adminCreateWithoutRs_memberInput>
    connect?: Enumerable<rs_board_adminWhereUniqueInput>
    connectOrCreate?: Enumerable<rs_board_adminCreateOrConnectWithoutrs_memberInput>
  }

  export type rs_board_likebad_mapCreateManyWithoutRs_memberInput = {
    create?: Enumerable<rs_board_likebad_mapCreateWithoutRs_memberInput>
    connect?: Enumerable<rs_board_likebad_mapWhereUniqueInput>
    connectOrCreate?: Enumerable<rs_board_likebad_mapCreateOrConnectWithoutrs_memberInput>
  }
  ...
  export type rs_mgr_memCreateManyWithoutRs_memberInput = {
    create?: Enumerable<rs_mgr_memCreateWithoutRs_memberInput>
    connect?: Enumerable<rs_mgr_memWhereUniqueInput>
    connectOrCreate?: Enumerable<rs_mgr_memCreateOrConnectWithoutrs_memberInput>
  }
  ...
  export type rs_board_adminUpdateManyWithoutRs_memberInput = {
    create?: Enumerable<rs_board_adminCreateWithoutRs_memberInput>
    connect?: Enumerable<rs_board_adminWhereUniqueInput>
    set?: Enumerable<rs_board_adminWhereUniqueInput>
    disconnect?: Enumerable<rs_board_adminWhereUniqueInput>
    delete?: Enumerable<rs_board_adminWhereUniqueInput>
    update?: Enumerable<rs_board_adminUpdateWithWhereUniqueWithoutRs_memberInput>
    updateMany?: Enumerable<rs_board_adminUpdateManyWithWhereWithoutRs_memberInput>
    deleteMany?: Enumerable<rs_board_adminScalarWhereInput>
    upsert?: Enumerable<rs_board_adminUpsertWithWhereUniqueWithoutRs_memberInput>
    connectOrCreate?: Enumerable<rs_board_adminCreateOrConnectWithoutrs_memberInput>
  }

  export type rs_board_likebad_mapUpdateManyWithoutRs_memberInput = {
    create?: Enumerable<rs_board_likebad_mapCreateWithoutRs_memberInput>
    connect?: Enumerable<rs_board_likebad_mapWhereUniqueInput>
    ...
    update?: Enumerable<rs_board_likebad_mapUpdateWithWhereUniqueWithoutRs_memberInput>
    updateMany?: Enumerable<rs_board_likebad_mapUpdateManyWithWhereWithoutRs_memberInput>
    deleteMany?: Enumerable<rs_board_likebad_mapScalarWhereInput>
    upsert?: Enumerable<rs_board_likebad_mapUpsertWithWhereUniqueWithoutRs_memberInput>
    connectOrCreate?: Enumerable<rs_board_likebad_mapCreateOrConnectWithoutrs_memberInput>
  }
  ...
  export type rs_mgr_memUpdateManyWithoutRs_memberInput = {
    create?: Enumerable<rs_mgr_memCreateWithoutRs_memberInput>
    connect?: Enumerable<rs_mgr_memWhereUniqueInput>
    ...
    update?: Enumerable<rs_mgr_memUpdateWithWhereUniqueWithoutRs_memberInput>
    updateMany?: Enumerable<rs_mgr_memUpdateManyWithWhereWithoutRs_memberInput>
    deleteMany?: Enumerable<rs_mgr_memScalarWhereInput>
    upsert?: Enumerable<rs_mgr_memUpsertWithWhereUniqueWithoutRs_memberInput>
    connectOrCreate?: Enumerable<rs_mgr_memCreateOrConnectWithoutrs_memberInput>
  }
  ...
  export type rs_board_postCreateManyWithoutRs_board_categoryInput = {
    create?: Enumerable<rs_board_postCreateWithoutRs_board_categoryInput>
    connect?: Enumerable<rs_board_postWhereUniqueInput>
    connectOrCreate?: Enumerable<rs_board_postCreateOrConnectWithoutrs_board_categoryInput>
  }

  export type rs_board_postUpdateManyWithoutRs_board_categoryInput = {
    create?: Enumerable<rs_board_postCreateWithoutRs_board_categoryInput>
    connect?: Enumerable<rs_board_postWhereUniqueInput>
    set?: Enumerable<rs_board_postWhereUniqueInput>
    disconnect?: Enumerable<rs_board_postWhereUniqueInput>
    delete?: Enumerable<rs_board_postWhereUniqueInput>
    update?: Enumerable<rs_board_postUpdateWithWhereUniqueWithoutRs_board_categoryInput>
    updateMany?: Enumerable<rs_board_postUpdateManyWithWhereWithoutRs_board_categoryInput>
    deleteMany?: Enumerable<rs_board_postScalarWhereInput>
    upsert?: Enumerable<rs_board_postUpsertWithWhereUniqueWithoutRs_board_categoryInput>
    connectOrCreate?: Enumerable<rs_board_postCreateOrConnectWithoutrs_board_categoryInput>
  }
  ...
  export type rs_board_categoryCreateOneWithoutRs_board_postInput = {
    create?: rs_board_categoryCreateWithoutRs_board_postInput
    connect?: rs_board_categoryWhereUniqueInput
    connectOrCreate?: rs_board_categoryCreateOrConnectWithoutrs_board_postInput
  }
  ...
  export type rs_board_categoryUpdateOneRequiredWithoutRs_board_postInput = {
    create?: rs_board_categoryCreateWithoutRs_board_postInput
    connect?: rs_board_categoryWhereUniqueInput
    update?: rs_board_categoryUpdateWithoutRs_board_postInput
    upsert?: rs_board_categoryUpsertWithoutRs_board_postInput
    connectOrCreate?: rs_board_categoryCreateOrConnectWithoutrs_board_postInput
  }
  ...
  export type rs_memberCreateOneWithoutRs_board_likebad_mapInput = {
    create?: rs_memberCreateWithoutRs_board_likebad_mapInput
    connect?: rs_memberWhereUniqueInput
    connectOrCreate?: rs_memberCreateOrConnectWithoutrs_board_likebad_mapInput
  }
  ...
  export type rs_memberUpdateOneRequiredWithoutRs_board_likebad_mapInput = {
    create?: rs_memberCreateWithoutRs_board_likebad_mapInput
    connect?: rs_memberWhereUniqueInput
    update?: rs_memberUpdateWithoutRs_board_likebad_mapInput
    upsert?: rs_memberUpsertWithoutRs_board_likebad_mapInput
    connectOrCreate?: rs_memberCreateOrConnectWithoutrs_board_likebad_mapInput
  }
  ...
  export type rs_memberUpdateOneRequiredWithoutRs_note_rs_memberTors_note_not_recv_idInput = {
    create?: rs_memberCreateWithoutRs_note_rs_memberTors_note_not_recv_idInput
    connect?: rs_memberWhereUniqueInput
  ...
  export type rs_board_postUpdateOneRequiredWithoutRs_noteInput = {
    create?: rs_board_postCreateWithoutRs_noteInput
    connect?: rs_board_postWhereUniqueInput
  ...
  export type rs_memberUpdateOneRequiredWithoutRs_note_rs_memberTors_note_not_send_idInput = {
    create?: rs_memberCreateWithoutRs_note_rs_memberTors_note_not_send_idInput
    connect?: rs_memberWhereUniqueInput
  ...
  export type rs_memberCreateOneWithoutRs_board_adminInput = {
    create?: rs_memberCreateWithoutRs_board_adminInput
    connect?: rs_memberWhereUniqueInput
    connectOrCreate?: rs_memberCreateOrConnectWithoutrs_board_adminInput
  }

  export type rs_memberUpdateOneRequiredWithoutRs_board_adminInput = {
    create?: rs_memberCreateWithoutRs_board_adminInput
    connect?: rs_memberWhereUniqueInput
    update?: rs_memberUpdateWithoutRs_board_adminInput
    upsert?: rs_memberUpsertWithoutRs_board_adminInput
    connectOrCreate?: rs_memberCreateOrConnectWithoutrs_board_adminInput
  }
  ...
  export type rs_board_adminCreateWithoutRs_memberInput = {
    adm_mem_id: string
  }

  export type rs_board_adminCreateOrConnectWithoutrs_memberInput = {
    where: rs_board_adminWhereUniqueInput
    create: rs_board_adminCreateWithoutRs_memberInput
  }

  export type rs_board_likebad_mapCreateWithoutRs_memberInput = {
    blm_update_timestemp: number
    blm_update_datetime: string
    blm_cnt_like?: number | null
    blm_cnt_bad?: number | null
  ...
  export type rs_board_likebad_mapCreateOrConnectWithoutrs_memberInput = {
    where: rs_board_likebad_mapWhereUniqueInput
    create: rs_board_likebad_mapCreateWithoutRs_memberInput
  }
  ...
  export type rs_board_adminUpdateWithWhereUniqueWithoutRs_memberInput = {
    where: rs_board_adminWhereUniqueInput
    data: rs_board_adminUpdateWithoutRs_memberInput
  }

  export type rs_board_adminUpdateManyWithWhereWithoutRs_memberInput = {
    where: rs_board_adminScalarWhereInput
    data: rs_board_adminUpdateManyMutationInput
  }

  export type rs_board_adminScalarWhereInput = {
    AND?: Enumerable<rs_board_adminScalarWhereInput>
    OR?: Enumerable<rs_board_adminScalarWhereInput>
    NOT?: Enumerable<rs_board_adminScalarWhereInput>
    adm_idx?: IntFilter | number
    adm_mem_idx?: IntFilter | number
    adm_mem_id?: StringFilter | string
  }

  export type rs_board_adminUpsertWithWhereUniqueWithoutRs_memberInput = {
    where: rs_board_adminWhereUniqueInput
    update: rs_board_adminUpdateWithoutRs_memberInput
    create: rs_board_adminCreateWithoutRs_memberInput
  }

  export type rs_board_likebad_mapUpdateWithWhereUniqueWithoutRs_memberInput = {
    where: rs_board_likebad_mapWhereUniqueInput
    data: rs_board_likebad_mapUpdateWithoutRs_memberInput
  }

  export type rs_board_likebad_mapUpdateManyWithWhereWithoutRs_memberInput = {
  ...
  export type rs_board_likebad_mapUpsertWithWhereUniqueWithoutRs_memberInput = {
    where: rs_board_likebad_mapWhereUniqueInput
    update: rs_board_likebad_mapUpdateWithoutRs_memberInput
    create: rs_board_likebad_mapCreateWithoutRs_memberInput
  }
  ...
  export type rs_mgr_memUpdateWithWhereUniqueWithoutRs_memberInput = {
    where: rs_mgr_memWhereUniqueInput
    data: rs_mgr_memUpdateWithoutRs_memberInput
  }

  export type rs_mgr_memUpdateManyWithWhereWithoutRs_memberInput = {
  ...
  export type rs_mgr_memUpsertWithWhereUniqueWithoutRs_memberInput = {
    where: rs_mgr_memWhereUniqueInput
  ...
  export type rs_board_postCreateWithoutRs_board_categoryInput = {
    pst_idx?: number
    pst_title: string
    pst_content: string
    pst_pass?: string | null
  ...
  export type rs_board_postCreateOrConnectWithoutrs_board_categoryInput = {
    where: rs_board_postWhereUniqueInput
    create: rs_board_postCreateWithoutRs_board_categoryInput
  }

  export type rs_board_postUpdateWithWhereUniqueWithoutRs_board_categoryInput = {
    where: rs_board_postWhereUniqueInput
    data: rs_board_postUpdateWithoutRs_board_categoryInput
  }

  export type rs_board_postUpdateManyWithWhereWithoutRs_board_categoryInput = {
    where: rs_board_postScalarWhereInput
    data: rs_board_postUpdateManyMutationInput
  }

  export type rs_board_postScalarWhereInput = {
    AND?: Enumerable<rs_board_postScalarWhereInput>
    OR?: Enumerable<rs_board_postScalarWhereInput>
    NOT?: Enumerable<rs_board_postScalarWhereInput>
    pst_idx?: IntFilter | number
    pst_title?: StringFilter | string
    pst_content?: StringFilter | string
    pst_pass?: StringNullableFilter | string | null
  ...
  export type rs_board_postUpsertWithWhereUniqueWithoutRs_board_categoryInput = {
    where: rs_board_postWhereUniqueInput
    update: rs_board_postUpdateWithoutRs_board_categoryInput
    create: rs_board_postCreateWithoutRs_board_categoryInput
  }
  ...
  export type rs_board_categoryCreateWithoutRs_board_postInput = {
    cat_idx: number
    cat_title: string
  }

  export type rs_board_categoryCreateOrConnectWithoutrs_board_postInput = {
    where: rs_board_categoryWhereUniqueInput
    create: rs_board_categoryCreateWithoutRs_board_postInput
  }
  ...
  export type rs_board_categoryUpdateWithoutRs_board_postInput = {
    cat_idx?: IntFieldUpdateOperationsInput | number
    cat_title?: StringFieldUpdateOperationsInput | string
  }

  export type rs_board_categoryUpsertWithoutRs_board_postInput = {
    update: rs_board_categoryUpdateWithoutRs_board_postInput
    create: rs_board_categoryCreateWithoutRs_board_postInput
  }
  ...
  export type rs_memberCreateWithoutRs_board_likebad_mapInput = {
    mem_userid?: string
    mem_userpw?: string
    mem_username?: string
    mem_email?: string
  ...
  export type rs_memberCreateOrConnectWithoutrs_board_likebad_mapInput = {
    where: rs_memberWhereUniqueInput
    create: rs_memberCreateWithoutRs_board_likebad_mapInput
  }
  ...
  export type rs_memberUpdateWithoutRs_board_likebad_mapInput = {
    mem_userid?: StringFieldUpdateOperationsInput | string
    mem_userpw?: StringFieldUpdateOperationsInput | string
    mem_username?: StringFieldUpdateOperationsInput | string
    mem_email?: StringFieldUpdateOperationsInput | string
  ...
  export type rs_memberUpsertWithoutRs_board_likebad_mapInput = {
    update: rs_memberUpdateWithoutRs_board_likebad_mapInput
    create: rs_memberCreateWithoutRs_board_likebad_mapInput
  }
  ...
  export type rs_memberCreateWithoutRs_board_adminInput = {
    mem_userid?: string
    mem_userpw?: string
    mem_username?: string
    mem_email?: string
  ...
  export type rs_memberCreateOrConnectWithoutrs_board_adminInput = {
    where: rs_memberWhereUniqueInput
    create: rs_memberCreateWithoutRs_board_adminInput
  }

  export type rs_memberUpdateWithoutRs_board_adminInput = {
    mem_userid?: StringFieldUpdateOperationsInput | string
    mem_userpw?: StringFieldUpdateOperationsInput | string
    mem_username?: StringFieldUpdateOperationsInput | string
    mem_email?: StringFieldUpdateOperationsInput | string
  ...
  export type rs_memberUpsertWithoutRs_board_adminInput = {
    update: rs_memberUpdateWithoutRs_board_adminInput
    create: rs_memberCreateWithoutRs_board_adminInput
  }
  ...
  export type rs_board_adminUpdateWithoutRs_memberInput = {
    adm_mem_id?: StringFieldUpdateOperationsInput | string
  }

  export type rs_board_likebad_mapUpdateWithoutRs_memberInput = {
    blm_update_timestemp?: IntFieldUpdateOperationsInput | number
    blm_update_datetime?: StringFieldUpdateOperationsInput | string
    blm_cnt_like?: NullableIntFieldUpdateOperationsInput | number | null
    blm_cnt_bad?: NullableIntFieldUpdateOperationsInput | number | null
  ...
  export type rs_board_postUpdateWithoutRs_board_categoryInput = {
    pst_title?: StringFieldUpdateOperationsInput | string
    pst_content?: StringFieldUpdateOperationsInput | string
    pst_pass?: NullableStringFieldUpdateOperationsInput | string | null
    pst_create_datetime?: StringFieldUpdateOperationsInput | string
...
/**
 * @deprecated Renamed to `Prisma.rs_board_categoryInclude`
 */
export type rs_board_categoryInclude = Prisma.rs_board_categoryInclude
...
/**
 * @deprecated Renamed to `Prisma.rs_board_adminInclude`
 */
export type rs_board_adminInclude = Prisma.rs_board_adminInclude
...
/**
 * @deprecated Renamed to `Prisma.Rs_board_adminListRelationFilter`
 */
export type Rs_board_adminListRelationFilter = Prisma.Rs_board_adminListRelationFilter
...
/**
 * @deprecated Renamed to `Prisma.Rs_board_postListRelationFilter`
 */
export type Rs_board_postListRelationFilter = Prisma.Rs_board_postListRelationFilter
...
/**
 * @deprecated Renamed to `Prisma.Rs_board_categoryRelationFilter`
 */
export type Rs_board_categoryRelationFilter = Prisma.Rs_board_categoryRelationFilter
...
/**
 * @deprecated Renamed to `Prisma.Not_idxNot_recv_idNot_send_idNot_relate_post_idxCompoundUniqueInput`
 */
export type Not_idxNot_recv_idNot_send_idNot_relate_post_idxCompoundUniqueInput = Prisma.Not_idxNot_recv_idNot_send_idNot_relate_post_idxCompoundUniqueInput
...
/**
 * @deprecated Renamed to `Prisma.rs_board_adminCreateManyWithoutRs_memberInput`
 */
export type rs_board_adminCreateManyWithoutRs_memberInput = Prisma.rs_board_adminCreateManyWithoutRs_memberInput

/**
 * @deprecated Renamed to `Prisma.rs_board_likebad_mapCreateManyWithoutRs_memberInput`
 */
export type rs_board_likebad_mapCreateManyWithoutRs_memberInput = Prisma.rs_board_likebad_mapCreateManyWithoutRs_memberInput
...
/**
 * @deprecated Renamed to `Prisma.rs_mgr_memCreateManyWithoutRs_memberInput`
 */
export type rs_mgr_memCreateManyWithoutRs_memberInput = Prisma.rs_mgr_memCreateManyWithoutRs_memberInput
...
/**
 * @deprecated Renamed to `Prisma.rs_board_adminUpdateManyWithoutRs_memberInput`
 */
export type rs_board_adminUpdateManyWithoutRs_memberInput = Prisma.rs_board_adminUpdateManyWithoutRs_memberInput

/**
 * @deprecated Renamed to `Prisma.rs_board_likebad_mapUpdateManyWithoutRs_memberInput`
 */
export type rs_board_likebad_mapUpdateManyWithoutRs_memberInput = Prisma.rs_board_likebad_mapUpdateManyWithoutRs_memberInput
...
/**
 * @deprecated Renamed to `Prisma.rs_mgr_memUpdateManyWithoutRs_memberInput`
 */
export type rs_mgr_memUpdateManyWithoutRs_memberInput = Prisma.rs_mgr_memUpdateManyWithoutRs_memberInput
...
/**
 * @deprecated Renamed to `Prisma.rs_board_postCreateManyWithoutRs_board_categoryInput`
 */
export type rs_board_postCreateManyWithoutRs_board_categoryInput = Prisma.rs_board_postCreateManyWithoutRs_board_categoryInput

/**
 * @deprecated Renamed to `Prisma.rs_board_postUpdateManyWithoutRs_board_categoryInput`
 */
export type rs_board_postUpdateManyWithoutRs_board_categoryInput = Prisma.rs_board_postUpdateManyWithoutRs_board_categoryInput
...
/**
 * @deprecated Renamed to `Prisma.rs_board_categoryCreateOneWithoutRs_board_postInput`
 */
export type rs_board_categoryCreateOneWithoutRs_board_postInput = Prisma.rs_board_categoryCreateOneWithoutRs_board_postInput
...
/**
 * @deprecated Renamed to `Prisma.rs_board_categoryUpdateOneRequiredWithoutRs_board_postInput`
 */
export type rs_board_categoryUpdateOneRequiredWithoutRs_board_postInput = Prisma.rs_board_categoryUpdateOneRequiredWithoutRs_board_postInput
...
/**
 * @deprecated Renamed to `Prisma.rs_memberCreateOneWithoutRs_board_likebad_mapInput`
 */
export type rs_memberCreateOneWithoutRs_board_likebad_mapInput = Prisma.rs_memberCreateOneWithoutRs_board_likebad_mapInput
...
/**
 * @deprecated Renamed to `Prisma.rs_memberUpdateOneRequiredWithoutRs_board_likebad_mapInput`
 */
export type rs_memberUpdateOneRequiredWithoutRs_board_likebad_mapInput = Prisma.rs_memberUpdateOneRequiredWithoutRs_board_likebad_mapInput
...
/**
 * @deprecated Renamed to `Prisma.rs_memberUpdateOneRequiredWithoutRs_note_rs_memberTors_note_not_recv_idInput`
 */
export type rs_memberUpdateOneRequiredWithoutRs_note_rs_memberTors_note_not_recv_idInput = Prisma.rs_memberUpdateOneRequiredWithoutRs_note_rs_memberTors_note_not_recv_idInput

/**
 * @deprecated Renamed to `Prisma.rs_board_postUpdateOneRequiredWithoutRs_noteInput`
 */
export type rs_board_postUpdateOneRequiredWithoutRs_noteInput = Prisma.rs_board_postUpdateOneRequiredWithoutRs_noteInput

/**
 * @deprecated Renamed to `Prisma.rs_memberUpdateOneRequiredWithoutRs_note_rs_memberTors_note_not_send_idInput`
 */
export type rs_memberUpdateOneRequiredWithoutRs_note_rs_memberTors_note_not_send_idInput = Prisma.rs_memberUpdateOneRequiredWithoutRs_note_rs_memberTors_note_not_send_idInput

/**
 * @deprecated Renamed to `Prisma.rs_memberCreateOneWithoutRs_board_adminInput`
 */
export type rs_memberCreateOneWithoutRs_board_adminInput = Prisma.rs_memberCreateOneWithoutRs_board_adminInput

/**
 * @deprecated Renamed to `Prisma.rs_memberUpdateOneRequiredWithoutRs_board_adminInput`
 */
export type rs_memberUpdateOneRequiredWithoutRs_board_adminInput = Prisma.rs_memberUpdateOneRequiredWithoutRs_board_adminInput
...
/**
 * @deprecated Renamed to `Prisma.rs_board_adminCreateWithoutRs_memberInput`
 */
export type rs_board_adminCreateWithoutRs_memberInput = Prisma.rs_board_adminCreateWithoutRs_memberInput

/**
 * @deprecated Renamed to `Prisma.rs_board_adminCreateOrConnectWithoutrs_memberInput`
 */
export type rs_board_adminCreateOrConnectWithoutrs_memberInput = Prisma.rs_board_adminCreateOrConnectWithoutrs_memberInput

/**
 * @deprecated Renamed to `Prisma.rs_board_likebad_mapCreateWithoutRs_memberInput`
 */
export type rs_board_likebad_mapCreateWithoutRs_memberInput = Prisma.rs_board_likebad_mapCreateWithoutRs_memberInput

/**
 * @deprecated Renamed to `Prisma.rs_board_likebad_mapCreateOrConnectWithoutrs_memberInput`
 */
export type rs_board_likebad_mapCreateOrConnectWithoutrs_memberInput = Prisma.rs_board_likebad_mapCreateOrConnectWithoutrs_memberInput
...
/**
 * @deprecated Renamed to `Prisma.rs_board_adminUpdateWithWhereUniqueWithoutRs_memberInput`
 */
export type rs_board_adminUpdateWithWhereUniqueWithoutRs_memberInput = Prisma.rs_board_adminUpdateWithWhereUniqueWithoutRs_memberInput

/**
 * @deprecated Renamed to `Prisma.rs_board_adminUpdateManyWithWhereWithoutRs_memberInput`
 */
export type rs_board_adminUpdateManyWithWhereWithoutRs_memberInput = Prisma.rs_board_adminUpdateManyWithWhereWithoutRs_memberInput

/**
 * @deprecated Renamed to `Prisma.rs_board_adminScalarWhereInput`
 */
export type rs_board_adminScalarWhereInput = Prisma.rs_board_adminScalarWhereInput

/**
 * @deprecated Renamed to `Prisma.rs_board_adminUpsertWithWhereUniqueWithoutRs_memberInput`
 */
export type rs_board_adminUpsertWithWhereUniqueWithoutRs_memberInput = Prisma.rs_board_adminUpsertWithWhereUniqueWithoutRs_memberInput

/**
 * @deprecated Renamed to `Prisma.rs_board_likebad_mapUpdateWithWhereUniqueWithoutRs_memberInput`
 */
export type rs_board_likebad_mapUpdateWithWhereUniqueWithoutRs_memberInput = Prisma.rs_board_likebad_mapUpdateWithWhereUniqueWithoutRs_memberInput

/**
 * @deprecated Renamed to `Prisma.rs_board_likebad_mapUpdateManyWithWhereWithoutRs_memberInput`
 */
export type rs_board_likebad_mapUpdateManyWithWhereWithoutRs_memberInput = Prisma.rs_board_likebad_mapUpdateManyWithWhereWithoutRs_memberInput
...
/**
 * @deprecated Renamed to `Prisma.rs_board_likebad_mapUpsertWithWhereUniqueWithoutRs_memberInput`
 */
export type rs_board_likebad_mapUpsertWithWhereUniqueWithoutRs_memberInput = Prisma.rs_board_likebad_mapUpsertWithWhereUniqueWithoutRs_memberInput
...
/**
 * @deprecated Renamed to `Prisma.rs_mgr_memUpdateWithWhereUniqueWithoutRs_memberInput`
 */
export type rs_mgr_memUpdateWithWhereUniqueWithoutRs_memberInput = Prisma.rs_mgr_memUpdateWithWhereUniqueWithoutRs_memberInput

/**
 * @deprecated Renamed to `Prisma.rs_mgr_memUpdateManyWithWhereWithoutRs_memberInput`
 */
export type rs_mgr_memUpdateManyWithWhereWithoutRs_memberInput = Prisma.rs_mgr_memUpdateManyWithWhereWithoutRs_memberInput
...
/**
 * @deprecated Renamed to `Prisma.rs_mgr_memUpsertWithWhereUniqueWithoutRs_memberInput`
 */
export type rs_mgr_memUpsertWithWhereUniqueWithoutRs_memberInput = Prisma.rs_mgr_memUpsertWithWhereUniqueWithoutRs_memberInput
...
/**
 * @deprecated Renamed to `Prisma.rs_board_postCreateWithoutRs_board_categoryInput`
 */
export type rs_board_postCreateWithoutRs_board_categoryInput = Prisma.rs_board_postCreateWithoutRs_board_categoryInput

/**
 * @deprecated Renamed to `Prisma.rs_board_postCreateOrConnectWithoutrs_board_categoryInput`
 */
export type rs_board_postCreateOrConnectWithoutrs_board_categoryInput = Prisma.rs_board_postCreateOrConnectWithoutrs_board_categoryInput

/**
 * @deprecated Renamed to `Prisma.rs_board_postUpdateWithWhereUniqueWithoutRs_board_categoryInput`
 */
export type rs_board_postUpdateWithWhereUniqueWithoutRs_board_categoryInput = Prisma.rs_board_postUpdateWithWhereUniqueWithoutRs_board_categoryInput

/**
 * @deprecated Renamed to `Prisma.rs_board_postUpdateManyWithWhereWithoutRs_board_categoryInput`
 */
export type rs_board_postUpdateManyWithWhereWithoutRs_board_categoryInput = Prisma.rs_board_postUpdateManyWithWhereWithoutRs_board_categoryInput

/**
 * @deprecated Renamed to `Prisma.rs_board_postScalarWhereInput`
 */
export type rs_board_postScalarWhereInput = Prisma.rs_board_postScalarWhereInput

/**
 * @deprecated Renamed to `Prisma.rs_board_postUpsertWithWhereUniqueWithoutRs_board_categoryInput`
 */
export type rs_board_postUpsertWithWhereUniqueWithoutRs_board_categoryInput = Prisma.rs_board_postUpsertWithWhereUniqueWithoutRs_board_categoryInput
...
/**
 * @deprecated Renamed to `Prisma.rs_board_categoryCreateWithoutRs_board_postInput`
 */
export type rs_board_categoryCreateWithoutRs_board_postInput = Prisma.rs_board_categoryCreateWithoutRs_board_postInput

/**
 * @deprecated Renamed to `Prisma.rs_board_categoryCreateOrConnectWithoutrs_board_postInput`
 */
export type rs_board_categoryCreateOrConnectWithoutrs_board_postInput = Prisma.rs_board_categoryCreateOrConnectWithoutrs_board_postInput
...
/**
 * @deprecated Renamed to `Prisma.rs_board_categoryUpdateWithoutRs_board_postInput`
 */
export type rs_board_categoryUpdateWithoutRs_board_postInput = Prisma.rs_board_categoryUpdateWithoutRs_board_postInput

/**
 * @deprecated Renamed to `Prisma.rs_board_categoryUpsertWithoutRs_board_postInput`
 */
export type rs_board_categoryUpsertWithoutRs_board_postInput = Prisma.rs_board_categoryUpsertWithoutRs_board_postInput
...
/**
 * @deprecated Renamed to `Prisma.rs_memberCreateWithoutRs_board_likebad_mapInput`
 */
export type rs_memberCreateWithoutRs_board_likebad_mapInput = Prisma.rs_memberCreateWithoutRs_board_likebad_mapInput

/**
 * @deprecated Renamed to `Prisma.rs_memberCreateOrConnectWithoutrs_board_likebad_mapInput`
 */
export type rs_memberCreateOrConnectWithoutrs_board_likebad_mapInput = Prisma.rs_memberCreateOrConnectWithoutrs_board_likebad_mapInput
...
/**
 * @deprecated Renamed to `Prisma.rs_memberUpdateWithoutRs_board_likebad_mapInput`
 */
export type rs_memberUpdateWithoutRs_board_likebad_mapInput = Prisma.rs_memberUpdateWithoutRs_board_likebad_mapInput

/**
 * @deprecated Renamed to `Prisma.rs_memberUpsertWithoutRs_board_likebad_mapInput`
 */
export type rs_memberUpsertWithoutRs_board_likebad_mapInput = Prisma.rs_memberUpsertWithoutRs_board_likebad_mapInput
...
/**
 * @deprecated Renamed to `Prisma.rs_memberCreateWithoutRs_board_adminInput`
 */
export type rs_memberCreateWithoutRs_board_adminInput = Prisma.rs_memberCreateWithoutRs_board_adminInput

/**
 * @deprecated Renamed to `Prisma.rs_memberCreateOrConnectWithoutrs_board_adminInput`
 */
export type rs_memberCreateOrConnectWithoutrs_board_adminInput = Prisma.rs_memberCreateOrConnectWithoutrs_board_adminInput

/**
 * @deprecated Renamed to `Prisma.rs_memberUpdateWithoutRs_board_adminInput`
 */
export type rs_memberUpdateWithoutRs_board_adminInput = Prisma.rs_memberUpdateWithoutRs_board_adminInput

/**
 * @deprecated Renamed to `Prisma.rs_memberUpsertWithoutRs_board_adminInput`
 */
export type rs_memberUpsertWithoutRs_board_adminInput = Prisma.rs_memberUpsertWithoutRs_board_adminInput
...
/**
 * @deprecated Renamed to `Prisma.rs_board_adminUpdateWithoutRs_memberInput`
 */
export type rs_board_adminUpdateWithoutRs_memberInput = Prisma.rs_board_adminUpdateWithoutRs_memberInput

/**
 * @deprecated Renamed to `Prisma.rs_board_likebad_mapUpdateWithoutRs_memberInput`
 */
export type rs_board_likebad_mapUpdateWithoutRs_memberInput = Prisma.rs_board_likebad_mapUpdateWithoutRs_memberInput
...
/**
 * @deprecated Renamed to `Prisma.rs_board_postUpdateWithoutRs_board_categoryInput`
 */
export type rs_board_postUpdateWithoutRs_board_categoryInput = Prisma.rs_board_postUpdateWithoutRs_board_categoryInput
